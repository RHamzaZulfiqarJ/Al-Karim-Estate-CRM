...
const Navbar = ({ setShowSidebar, showSidebar, tasks, notifications }) => {
  /////////////////////////////////////////// VARIABLES ////////////////////////////////////////////
          ...
          <div className={`flex justify-start gap-[10px] items-center`}>
            ...
            <div>
              <p className="text-sky-400 text-xl gap-1 flex items-center">
                ...
                <span ref={clockRef}>{new Date().toLocaleTimeString()}</span>
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-[20px] ">
            ...
            <div className="sm:flex items-center hidden gap-[10px] ">
              <Dropdown>
                ...
                <Menu slots={{ listbox: StyledListbox }} className="z-50">
                  {notifications.length > 0 ? (
              ...
              <Dropdown>
                ...
                <Menu slots={{ listbox: StyledListbox }} className="z-50">
                  ...
                  {tasks.slice(0, 5).map((task, index) => (
                    <React.Fragment key={index}>
                      <StyledMenuItem className="text-gray-600 flex w-full">
                        <div className="w-full">
                          <div className="flex justify-between items-center gap-10">
                            <span className="text-lg font-light text-sky-400">{formatLabel(task.newTask)}</span>
