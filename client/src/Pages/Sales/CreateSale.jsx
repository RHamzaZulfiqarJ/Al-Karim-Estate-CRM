        ...
        <DialogContent>
          <div className="flex flex-col gap-2 p-3 pb-0 text-gray-500 font-primary">
            ...
            <table className="mt-4">
              ...
              <tr>
                ...
                <td className="pb-4">
                  <TextField
                    ...
                    value={saleData.profit = saleData.netPrice - saleData.receivedAmount}
                    name="profit"
                    size="small"
                    type="number"
                    disabled
              ...
              {saleData?.paymentType === "cheque" || saleData?.paymentType === "card" ? (
                <tr>
                  <td className="pb-4 text-lg">{saleData?.paymentType === "cheque" ? "Cheque No." : "Card No."} </td>
                  <td className="pb-4">
                    <TextField
                      name="number"
                      value={saleData?.number}
