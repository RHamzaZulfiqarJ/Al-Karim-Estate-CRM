...
function Sales() {
  ...
  const columns = [
    ...
    },
    {
      ...
      headerName: "Profit",
      width: 150,
      renderCell: (params) => <div className="font-primary">{params.row.profit}</div>,
    },
    {
      field: "createdAt",
      headerClassName: "super-app-theme--header",
    ...
    },
    {
      ...
      width: 140,
      renderCell: (params) => <div className="font-primary">{params.row.netPrice}</div>,
    },
    {
      field: "received",
      headerClassName: "super-app-theme--header",
      ...
      width: 200,
      renderCell: (params) => <div className="font-primary">{params.row.receivedAmount}</div>,
    },
