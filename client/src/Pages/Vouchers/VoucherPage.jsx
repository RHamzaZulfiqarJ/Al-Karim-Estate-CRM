...
const VoucherPage = ({ }) => {
  ...
  return (
    <div
      ref={pdfRef}
      className="completePdfPage flex justify-center items-center"
      style={{
        width: "1024px",
        height: "auto",
        margin: "0 auto",
    ...
    >
      <div className="w-[51rem] h-full pt-10 bg-white">
        ...
        <div className="flex justify-center flex-col py-2">
          <p className="text-center">&copy; Right Reserverd by Alkarim Estate Builders</p>
          <p className="text-center">alkarimestatebuilders@gmail.com</p>
          <p className="text-center">Floor 4th, Plaza 267 Main boulevard DHA Phase 6 Lahore</p>
        </div>
      </div>
